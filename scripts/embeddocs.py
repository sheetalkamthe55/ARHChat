...
if __name__ == "__main__":
    ...
    parser.add_argument("pdf_folder_path", help="Path to read PDFs")
    ...
    parser.add_argument("--api_key", help="API key for authentication of vectordatabase (optional)", default=None)

    args = parser.parse_args()

    main(args.pdf_folder_path, args.model_name,args.collection_name,args.api_key)
